...
{
    public Vector2Int depthResolution = new Vector2Int();
    public Vector2Int rgbResolution = new Vector2Int();
    ...
    public bool _shouldEnableDepth = false;
    public bool _shouldEnableColor = false;
    public bool _shouldEnableBody = false;
    ...
    public void InitializeStreams()
    {
        try
        {
            ...
            foreach (var mode in depthModes)
            {
                if (mode.Width == depthResolution.x && mode.Height == depthResolution.y && mode.FramesPerSecond > 29)
                {
            ...
            {
                if (mode.Width == rgbResolution.x && mode.Height == rgbResolution.y && mode.FramesPerSecond > 29)
                {
